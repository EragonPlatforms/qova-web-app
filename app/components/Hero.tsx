...
const Hero = () => {
  return (
    <section className="flex flex-col-reverse md:flex-row h-[90vh] max-w-7xl w-[90%] bg-cover items-center justify-between text-center md:text-left min-w-7xl mx-auto py-10">
      ...
      <aside className="aspect-square relative w-full">
        <Image
